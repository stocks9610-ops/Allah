    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-md p-0 sm:p-4">
      <div className="bg-[#131722] w-full h-full sm:h-auto sm:max-h-[90vh] sm:max-w-4xl sm:rounded-[2.5rem] flex flex-col overflow-hidden animate-in zoom-in-95 shadow-2xl border border-white/5">
        ...
        <div className="p-6 md:p-8 border-b border-[#2a2e39] bg-gradient-to-r from-[#1e222d] to-[#131722] shrink-0 relative">
          <button onClick={onClose} className="absolute top-4 right-4 text-gray-500 p-2 hover:text-white transition-colors bg-white/5 rounded-full z-10">
          ...
          <div className="flex items-center gap-4 md:gap-6">
            <div className="relative">
               ...
               {trader.youtubeLink && (
                 <button 
                   ...
                   className="absolute -top-3 -left-3 w-10 h-10 bg-[#FF0000] rounded-full flex items-center justify-center shadow-[0_0_25px_rgba(255,0,0,0.6)] animate-pulse border-2 border-white/20 hover:scale-110 transition-transform"
            ...
            <div className="min-w-0 flex-1">
              ...
              <span className="text-[10px] text-gray-500 font-black uppercase tracking-widest block mb-2 italic">CopyTrade ID: {trader.copyTradeId}</span>
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar bg-[#131722]">
          <div className="p-6 md:p-8 space-y-8">
            ...
            <div className="bg-gradient-to-br from-[#1e222d] to-black p-6 rounded-[2rem] border border-white/10 relative overflow-hidden">
               <div className="absolute -top-10 -right-10 w-32 h-32 bg-[#f01a64]/10 rounded-full blur-3xl"></div>
               <h4 className="text-[9px] text-[#f01a64] font-black uppercase tracking-widest mb-3 flex items-center gap-2">
                 ...
                 Market Edge Analysis & Bio
               </h4>
               <p className="text-gray-300 text-[11px] md:text-xs font-medium italic leading-relaxed relative z-10 first-letter:text-2xl first-letter:font-black first-letter:text-[#f01a64] first-letter:mr-1 first-letter:float-left">
                 {trader.bio}
               </p>
            </div>
          ...
          {!showDeployConfig ? (
             <div className="flex gap-3">
               {trader.youtubeLink && (
                 <button 
                   onClick={() => window.open(trader.youtubeLink, '_blank')}
                   className="flex-1 bg-[#FF0000]/10 border border-[#FF0000]/30 hover:bg-[#FF0000]/20 py-4 rounded-xl font-black text-white text-[10px] uppercase tracking-widest transition-all active:scale-95 flex items-center justify-center gap-2"
                 >
               ...
               <button 
                 ...
                 className="flex-[2] bg-[#f01a64] hover:bg-pink-700 py-4 rounded-xl font-black text-white text-xs uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(240,26,100,0.4)] active:scale-95 transition-all flex items-center justify-center gap-2"
               >
                 Copy Strategy
