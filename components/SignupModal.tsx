    ...
    try {
      if (isLogin) {
        ...
        const tempUser: UserProfile = {
          ...
          nodeId: '', // Will be generated by authService
          referralCount: 0,
          referralEarnings: 0,
          pendingClaims: 0
        };
        ...
        if (success) {
          // Fetch the fully processed user object from storage (with hashed password and generated Node ID)
          // This ensures the App state matches the DB state immediately
      ...
      alert("A system error occurred. Please check console or try again.");
      setIsSubmitting(false);
    }
  };
